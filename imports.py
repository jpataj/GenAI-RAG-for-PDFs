...
class RAG:
    ...
    def get_text(self, page, lines_to_skip = 0):
        """
    ...
    def query(self, question, num_results = 5, include_attributions=False, rights=0, debug=False):
        ...
        prompt = f"""
            ...
            in your dataset. Remind user that missing data in your dataset does not mean it is allowed in policy. Refer to the datasource as 'my sources' any time you might use the word 'datasource'.
